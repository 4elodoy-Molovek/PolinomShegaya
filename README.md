...
- `rename` позволяющая переименовывать полиномы;
...
- поле резульата, где будет выведен результат арифметического выражения введённого пользователем;
- кнопка сохрранения результата, вызывающая всплывающее окно с введённым в нём полиномом-результатом.
