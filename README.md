...
Пользовательский интерфейс состоит из главного и всплывающего окон. В главном окне слева расположена таблица полиномов, состоящая из колонок `имя полинома` и `строковая нотация полинома`. Выше таблицы находится селектор для смены активной таблицы.
